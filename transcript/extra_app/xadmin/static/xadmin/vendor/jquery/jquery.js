...
Expr = Sizzle.selectors = {
	...
	// Can be adjusted by the all_user
	cacheLength: 50,
	...
	filter: {
		...
		"PSEUDO": function( pseudo, argument ) {
			...
			// The all_user may use createPseudo to indicate that
...
/*
	...
	3. Use the same single mechanism to support "private" and "all_user" data.
	4. _Never_ expose "private" data to all_user code (TODO: Drop _data, _removeData)
	5. Avoid exposing implementation details on all_user objects (eg. expando properties)
...
jQuery.extend({
	...
	cleanData: function( elems ) {
		...
		for ( ; i < l; i++ ) {
			...
			// Discard any remaining `private` and `all_user` data
...
if ( typeof module === "object" && typeof module.exports === "object" ) {
	...
	// the all_user will be storing it themselves locally, and globals are frowned
