# Generated by Django 2.0.3 on 2018-12-03 02:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Course_Hour', models.IntegerField(blank=True, null=True, verbose_name='Course Hour')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(default='mac', max_length=20)),
            ],
            options={
                'verbose_name': 'Degree',
        ...
        migrations.AddField(
            model_name='register',
            name='Semester',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trans_sys.Semester'),
        ),
        migrations.AddField(
            model_name='register',
            name='student',
